...
namespace BimmerRacing.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public OrdersController(BRContextDB context)
        {
            _context = context;
        }
        ...
        {
            var bRContextDB = _context.Order.Include(o => o.Customer);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,CustomerId,OrderStatus,RequiredDate,ShippedDate")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
